            ...
            <div className="gradient3 w-screen z-50 -mt-[17rem] xl:pb-[16rem]" id="menuComponent" >
                <motion.div className="container flex-wrap">
                    <motion.div className="aboutHero grid w-screen items-center justify-center">
                        <div className="xl:mt-[5rem] -mt-10 xl:-mb-[1.5rem] text-center font-mari tracking-widest text-[3rem] xl:text-[8rem] text-[#D8C29D]">
                            <motion.div
...
234 294 234 310 0 16 -222 310 -234 310 -4 0 -59 -66 -121 -147z"/>
                                ...
                                </svg> CATERING MENU <svg className="mt-12 -ml-[5rem] xl:mr-0" version="1.0" xmlns="http://www.w3.org/2000/svg"
                                    width="64.000000pt" height="64.000000pt" viewBox="0 0 64.000000 64.000000"
                                    preserveAspectRatio="xMidYMid meet">
...
234 294 234 310 0 16 -222 310 -234 310 -4 0 -59 -66 -121 -147z"/>
                    ...
                    <section className="container py-[1rem] xl:w-5/6 bg-[#D8C29D] shadow-[1px_35px_35px_2px_rgba(0,0,0,0.5)] mt-[2rem] md:mt-[3rem] md:mx-auto items-center justify-center text-center h-auto md:h-[117rem] md:ml-[15rem] rounded-xl z-50 bg-fixed bg-deco2">
                        <div className="container my-20 px-6 mx-auto text-xl">
                            <motion.div
                                variants={pack2}
                                initial="initial"
                                whileInView="animate"
                                className="block xl:mx-[18rem] bg-[#D8C29D] py-[2rem] mb-[2rem] border-seperate border-2 border-[#07252d] rounded-lg shadow-lg">
                            ...
                            <div className="grid gap-6 lg:gap-x-12">
                                <div className="grid gap-4 grid-rows-2 mb-6 lg:mb-0">
                                    ...
                                    <motion.div
                                        ...
                                        initial="initial"
                                        whileInView="animate"
                                        className="block col-span-2 border-spacing-[3rem] bg-[#D8C29D] border-seperate border-2 border-solid border-[#07252d] rounded-lg shadow-lg py-[2rem] xl:h-[50rem]">
                            ...
                            <motion.div
                                ...
                                initial="initial"
                                whileInView="animate"
                                className="flex flex-row text-center justify-center xl:mx-[18rem] bg-[#07252d] mt-[7rem] py-[2rem] mb-[2rem] border-2 border-[#D8C29D] rounded-lg shadow-lg hover:cursor-pointer ">
