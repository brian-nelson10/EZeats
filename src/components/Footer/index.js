        ...
        <div>
          ...
          <nav aria-label="Footer Navigation - Services" className="mt-6">
            <ul className="space-y-4 text-sm">
              <li>
                <a href="#" className="text-[#D8C29D] text-[1.4rem] tracking-widest font-rah transition hover:opacity-75">
                  Order Online
                </a>
              </li>
...
<div className="grid grid-rows-2">
  <div className="text-center justify-center items-center grid mb-[1rem] ml-[4rem]">
<motion.svg xmlns="http://www.w3.org/2000/svg" width="30%" viewBox="0 0 70.744 90.043" className="rotate-[180deg]">
  ...
  <div className="items-center text-center grid mr-[3rem] font-rah text-[#D8C29D] text-[1.1rem] -mt-[3rem]">Back Up</div>
</div>
      </div>
    </div>
